...
if __name__ == "__main__":
    for feature in l2v.FEATURE_SETS:
        result_sizesvsvecs = run_correlation_analysis(mode="sizesvsvecs", task="xnli", features=feature, model="mbert",
                                                      similarity_strategy="to_en",k="", aggregation_strategy="", sampling_strategy="")
        
        result_normal = run_correlation_analysis(mode="normal", task="xnli", features=feature, model="mbert",
                                                 similarity_strategy="to_en",k=0, aggregation_strategy="plain", sampling_strategy="RANDOM")
